...
sequelize = new Sequelize "ozgweb", null, null, { dialect: "sqlite", storage: "./db.sys" }
...
exports.ArtSingle = sequelize.define "ArtSingle", {
	name: Sequelize.STRING,
...
exports.DataClass = sequelize.define "DataClass", {
	name: Sequelize.STRING,
